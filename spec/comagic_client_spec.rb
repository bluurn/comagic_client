    ...
    describe "when logged in" do
      ...
      describe "communications feature" do
        ...
        it 'get communications if all parameters given' do
          expect(agency_connector.communication customer_id: config['accounts']['agency']['customer_id'], site_id: config['accounts']['agency']['site_id'], date_from: config['accounts']['agency']['date_from'], date_till: config['accounts']['agency']['date_from']).to be_a Array
        end
